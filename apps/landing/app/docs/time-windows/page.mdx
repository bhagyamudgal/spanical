export const metadata = {
    title: "Time windows",
    description:
        "How spanical selects analysis windows: --last, --this, --ytd and date ranges, automatic granularity, and timezone handling.",
};

# Time windows

Every insight command works over a window. You pick it with exactly one
selector group; with no selector the default is the last 12 months.
...
Periods are weekly, monthly, or quarterly, chosen automatically from the
window span:
