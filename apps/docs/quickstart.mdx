---
title: "Quickstart"
description: "Get a report running, then dig into hotspots and ticket flow."
---
...
The token needs read access to the repositories you analyse. Full setup is on [Config file](/configuration/config-file).
...
Next: [installation](/installation) if you have not installed yet, or the [command reference](/commands/overview) for everything else.
