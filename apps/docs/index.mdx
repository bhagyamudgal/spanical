...
The [command reference](/commands/overview) covers all ten commands. These docs reuse the report's own vocabulary (throughput churn, hotspot, sole owner), so a term means the same thing here as in the output.
