---
title: "Reviews"
description: "Show per-dev review load, review latency and team review coverage (GitHub)."
---

`spanical reviews` measures the contribution that never shows up in line counts: reviews given, how fast they landed, and whether merged work gets looked at by anyone other than its author. It shares the ticket layer's sync and preconditions with [tickets](/commands/tickets).
