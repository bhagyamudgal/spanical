---
title: "Tickets"
description: "Show per-dev pull request and issue flow, cycle time and thrash (GitHub)."
---
...
| Option                             | Values | Notes                                           |
| ---------------------------------- | ------ | ----------------------------------------------- |
| All global flags except `--period` |        | See [global flags](/configuration/global-flags) |
