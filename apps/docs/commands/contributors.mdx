---
title: "Contributors"
description: "Show per-dev activity across the whole window, with approximate complexity attribution."
---
...
Map them in the [identity bridge](/configuration/config-file#schema) to merge their numbers under one canonical author.
