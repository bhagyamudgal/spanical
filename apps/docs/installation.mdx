...
The command downloads the latest release asset for your platform, verifies its SHA256 checksum, and replaces the binary. See [update](/commands/update). Source installs have no self-update; pull and rebuild.
